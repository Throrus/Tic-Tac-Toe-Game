...
def redrawGameWindow():
    ...
    game_win.blit(text1, (58,13))
    game_win.blit(text2, (350,558))
    game_win.blit(reset_text, (494,27))
    if player_x_turn == True:
        game_win.blit(turnx_text, (16,547))
    else:
        game_win.blit(turno_text, (15,547))
